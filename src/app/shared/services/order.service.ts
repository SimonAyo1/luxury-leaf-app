...
export class OrderService {
  ...
  public createOrder(product: any, details: any, orderId: any, amount: any, paymentStatus: string, paymentMethod) {
    ...
    return setDoc(orderDocRef, item).then((response) => {
      ...
      this.http.post("https://luxuryleaf-api.vercel.app/api/order-mail", { email: details?.email, orderLink: `https://luxuryleafcompany.com/store/checkout/success/${orderId}` }).subscribe({
        next: () => {
